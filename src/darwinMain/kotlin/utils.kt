...
internal fun AddressScheme.toCore(): BRCryptoAddressScheme {
    return when (this) {
        ...
        AddressScheme.ETHDefault -> CRYPTO_ADDRESS_SCHEME_ETH_DEFAULT
        AddressScheme.GENDefault -> CRYPTO_ADDRESS_SCHEME_GEN_DEFAULT
    }
}
...
internal fun BRCryptoTransferState.toTransferState(): TransferState = when (type) {
