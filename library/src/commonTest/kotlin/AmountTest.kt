...
class AmountTest {
    ...
    fun testUnit() {
        ...
        val unitSat = UnitWK.create(btc, "BTC-SAT", "Satoshi", "SAT")
        val unitBtc = UnitWK.create(btc, "BTC-BTC", "Bitcoin", "B", unitSat, 8u)
    ...
    fun testAmount() {
        ...
        val unitSatoshi = UnitWK.create(btc, "BTC-SAT", "Satoshi", "SAT")
        val unitBtc = UnitWK.create(btc, "BTC-BTC", "Bitcoin", "B", unitSatoshi, 8u)

        val unitWei = UnitWK.create(eth, "ETH-WEI", "WEI", "wei")
        val unitGwei = UnitWK.create(eth, "ETH-GWEI", "GWEI", "gwei", unitWei, 9u)
        val unitEther = UnitWK.create(eth, "ETH-ETH", "ETHER", "E", unitWei, 18u)
    ...
    fun testAmountExtended() {
        ...
        val unitSatoshi = UnitWK.create(btc, "BTC-SAT", "Satoshi", "SAT")
        val unitMongo = UnitWK.create(btc, "BTC-MONGO", "BitMongo", "BM", unitSatoshi, 70u)
    ...
    fun testCurrencyPair() {
        ...
        val unitUsdCents = UnitWK.create(usd, "USD-Cents", "Cents", "c")
        val unitUsdDollar = UnitWK.create(usd, "USD-Dollar", "Dollars", "$", unitUsdCents, 2u)
