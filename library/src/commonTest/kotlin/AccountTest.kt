...
class AccountTest {
    ...
    val phrase = "ginger settle marine tissue robot crane night number ramp coast roast critic".encodeToByteArray()
    ...
    fun testPhrase() {
        ...
        assertTrue(Account.validatePhrase(phrase, WORDS))
        assertFalse(Account.validatePhrase("Ask @jmo for a pithy quote".encodeToByteArray(), WORDS))
    }
