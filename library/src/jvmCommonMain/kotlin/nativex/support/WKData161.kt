...
internal open class WKData16 : Structure {
    @JvmField
    var u8 = ByteArray(128 / 8) // UInt128
    ...
    class ByReference : WKData16(), Structure.ByReference
    class ByValue : WKData16(), Structure.ByValue
}