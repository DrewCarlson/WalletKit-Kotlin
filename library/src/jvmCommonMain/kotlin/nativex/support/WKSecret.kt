...
open class WKSecret : Structure {
    ...
    override fun getFieldOrder(): List<String> = listOf("u8")
    ...
    class ByReference : WKSecret(), Structure.ByReference
    class ByValue : WKSecret(), Structure.ByValue
}